...
static int runApp(int argc, char** argv)
{
	for (int i= 1; i < argc; ++i)
	{
		...
		if (std::string(argv[i]) == "--replay-verify")
		{
			LoggerSettings loggerSettings= {};
			loggerSettings.min_log_level= LogSeverityLevel::info;
			loggerSettings.log_filename= "replay-verify.log";
			loggerSettings.enable_console= true;
			log_init(loggerSettings);
		...
		if (std::string(argv[i]) == "--replay-dump")
		{
			LoggerSettings loggerSettings= {};
			loggerSettings.min_log_level= LogSeverityLevel::info;
			loggerSettings.log_filename= "replay-dump.log";
			loggerSettings.enable_console= true;
			log_init(loggerSettings);
			...
			const std::string recordingPath= argv[i + 1];
			const int firstFrame= atoi(argv[i + 2]);
			const int lastFrame= atoi(argv[i + 3]);
			const std::string outPath= (i + 4 < argc)
				? argv[i + 4]
		...
		if (std::string(argv[i]) == "--test-replay")
		{
			LoggerSettings loggerSettings= {};
			loggerSettings.min_log_level= LogSeverityLevel::info;
			loggerSettings.log_filename= "test-replay.log";
			loggerSettings.enable_console= true;
			log_init(loggerSettings);
