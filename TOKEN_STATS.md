...
<!-- TOKEN_STATS:BEGIN -->
Last regenerated 2026-08-12 07:37 UTC by `tools/token_stats.py`.
...
| LEARNINGS.md and token stats (Aug 12) | claude-fable-5 | 19 | 40,321 | 1,757,658 | 114,886 |

## Totals per model

| Model | API calls | Input | Cache write | Cache read | Output | Weighted |
|---|---|---|---|---|---|---|
| claude-fable-5 | 1,432 | 13,529 | 8,251,395 | 528,185,348 | 1,934,329 | 14,563,590 |
| claude-opus-5 | 1,737 | 6,084 | 8,935,685 | 751,289,991 | 1,904,068 | 19,165,005 |
| **total** | 3,169 | 19,613 | 17,187,080 | 1,279,475,339 | 3,838,397 | **33,728,596** |

## Energy and water estimate

| Scenario | Wh per 1k weighted tokens | Energy | Water (onsite cooling) | Water (incl. generation) |
|---|---|---|---|---|
| low | 0.5 | 17 kWh | 19 L | 51 L |
| central | 2.0 | 67 kWh | 74 L | 202 L |
| high | 6.0 | 202 kWh | 223 L | 607 L |
<!-- TOKEN_STATS:END -->
